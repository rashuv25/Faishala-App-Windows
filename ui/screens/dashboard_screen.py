...
class HoverableDocumentRow(ctk.CTkFrame):
    ...
    def __init__(
        ...
        self._hover_color = AppTheme.ROW_HOVER
    ...
    def _create_widgets(self):
        ...
        rename_btn = ctk.CTkButton(
            ...
            font=("Arial", 16),
            fg_color="transparent",
            hover_color=AppTheme.RENAME_HOVER,
            text_color=AppTheme.TEXT_PRIMARY,
            corner_radius=6,
        ...
        duplicate_btn = ctk.CTkButton(
            ...
            font=("Arial", 16),
            fg_color="transparent",
            hover_color=AppTheme.DUPLICATE_HOVER,
            text_color=AppTheme.TEXT_PRIMARY,
            corner_radius=6,
        ...
        export_btn = ctk.CTkButton(
            ...
            font=("Arial", 16),
            fg_color="transparent",
            hover_color=AppTheme.EXPORT_HOVER,
            text_color=AppTheme.TEXT_PRIMARY,
            corner_radius=6,
...
class DashboardScreen(ctk.CTkFrame):
    ...
    def _create_widgets(self):
        ...
        self.top_pagination_frame = None
    ...
    def _create_pagination(self, parent_frame):
        ...
        for page_num in range(start_page, end_page + 1):
            ...
            page_btn = ctk.CTkButton(
                ...
                hover_color=AppTheme.SECONDARY_COLOR if is_current else AppTheme.HOVER_LIGHT,
