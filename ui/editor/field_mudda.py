...
class MuddaField(ctk.CTkFrame):
    ...
    def _create_widgets(self):
        ...
        mudda_row = ctk.CTkFrame(inner, fg_color="transparent")
        mudda_row.pack(fill="x", pady=(0, 10))
        ...
        number_row = ctk.CTkFrame(inner, fg_color="transparent")
